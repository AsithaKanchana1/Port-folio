  ...
  return (
    <motion.div variants={fadeIn("up", "spring")}>
      <Tilt
        ...
        className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full cursor-pointer hover:bg-tertiary/80 transition-colors duration-300"
        ...
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            <div
              ...
              className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer hover:bg-black/80 transition-colors duration-200"
            >
